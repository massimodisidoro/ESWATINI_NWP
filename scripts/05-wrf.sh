...
#mpirun -np $nprocs_wrf --hostfile $dir_tmp/hostfile $dir_exe/wrf.exe &> $logdir/log_05-wrf_${date_forecast}.log
mpirun -np $nprocs_wrf $dir_exe/wrf.exe &> $logdir/log_05-wrf_${date_forecast}.log
cp namelist.input $logdir/namelist.input_$date_forecast
mv rsl* $logdir/wrflog
